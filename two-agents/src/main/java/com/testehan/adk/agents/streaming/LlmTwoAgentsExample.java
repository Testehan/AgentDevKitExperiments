...
public class LlmTwoAgentsExample {
    ...
    // Define the Tool (Only for the first agent) ---
    ...
    public static void main(String[] args){
        LlmTwoAgentsExample agentExample = new LlmTwoAgentsExample();
    ...
    public void callAgentAndPrint(Runner runner, LlmAgent agent, String sessionId, String queryJson) {
        ...
        Session updatedSession =
                runner
                        ...
                        .blockingGet();
// todo in the below print, one should print updatedSession.state().get(agent.outputKey.get()) ..right now it prints the key used to set something
